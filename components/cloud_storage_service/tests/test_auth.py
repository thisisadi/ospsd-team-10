...
from s3_client_impl import token_store as token_store_mod
...
def test_auth_callback_success_stores_token_and_redirects(
    ...
    monkeypatch.setattr("cloud_storage_service.routes.auth.store_token", _spy_store)
    monkeypatch.setattr(
        "cloud_storage_service.routes.auth.exchange_code_for_token",
