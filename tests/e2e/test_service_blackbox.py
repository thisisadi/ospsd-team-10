...
@pytest.mark.e2e
def test_service_health_blackbox(running_service: tuple[str, Any]) -> None:
...
@pytest.mark.e2e
def test_service_openapi_blackbox(running_service: tuple[str, Any]) -> None:
...
@pytest.mark.e2e
def test_service_storage_requires_auth_blackbox(
    running_service: tuple[str, Any],
) -> None:
