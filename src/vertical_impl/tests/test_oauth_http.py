...
import pytest
import requests
from vertical_impl.oauth import exchange_code_for_token, refresh_access_token
...
def test_exchange_code_for_token_parses_response(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("vertical_impl.oauth.requests.post", _fake_post)
...
def test_refresh_access_token_parses_response(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        "vertical_impl.oauth.requests.post",
